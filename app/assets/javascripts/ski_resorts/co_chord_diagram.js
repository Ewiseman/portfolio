$(document).ready(function() {
  ...
  var loadVisualization = $("#co-chord-diagram").length > 0;
  ...
  var margin = {top: 20, right: 50, bottom: 50, left:0},
      width = $("#co-chord-diagram").width(),
      height = $("#co-chord-diagram").width(),
  ...
  var svg = d3v3.select("#co-chord-diagram").append("svg")
    .attr("width", width)
    .attr("height", height)
    .append("g")
 ...
 // Set the ending color (at 100%)//
  ...
  svg.append("g").selectAll("path")
    ...
    .attr("class", "group")
    .attr("d", d3v3.svg.arc().innerRadius(innerRadius).outerRadius(outerRadius))
  ...
  svg.append("g")
    ...
    .enter()
    .append("path")
    .attr("d", d3v3.svg.chord().radius(innerRadius-2))

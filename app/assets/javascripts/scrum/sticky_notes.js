$(document).ready(function() {
  ...
  var svgHello = d3v3.select("#sticky-notes")
  ...
  d3v3.csv("/task_reports.csv", function(error, data) {
    ...
    // var dateSort = function(a, b) { return d3v3.descending(b.date, a.date) && d3v3.descending(b.key, a.key);; };
    // var keySort = function(a, b) { return d3v3.descending(a.key, b.key); };
    ...
    new scroll('color-coded', '75%', grid3v3, grid2);
    new scroll('health', '75%', grid4, grid3v3);

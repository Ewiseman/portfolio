...
class ProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create program" do
    assert_difference('Program.count') do
      post programs_url, params: { program: { name: @program.name, new_tag: @program.new_tag } }
    end
  ...
  test "should update program" do
    patch program_url(@program), params: { program: { name: @program.name, new_tag: @program.new_tag } }
